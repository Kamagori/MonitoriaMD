...
//     printf("Digite os valores do primeiro vetor de 10 elementos:\n");
//     for (int i = 0; i < tamanho; i++) {
//         printf("Digite o elemento %d: ", i + 1);
...
//     }
//     printf("\n");
//     printf("Segundo Vetor (em ordem invertida do primeiro):\n");
//     for (int i = 0; i < tamanho; i++) {
...
// int main() {
//     int numMercadorias = 10;
//     double precos[numMercadorias];
//     int quantidadesVendidas[numMercadorias];
//     double faturamentoMensal = 0.0;
//     printf("Digite os preços de venda das 100 mercadorias:\n");
//     for (int i = 1; i <= numMercadorias; i++) {
//         printf("Preço da mercadoria %d: ", i);
//         scanf("%lf", &precos[i]);
//     }
//     printf("Digite as quantidades vendidas das 100 mercadorias (0 para nenhuma venda):\n");
//     for (int i = 1; i <= numMercadorias; i++) {
//         printf("Quantidade vendida da mercadoria %d: ", i);
//         scanf("%d", &quantidadesVendidas[i]);
//     }
//     for (int i = 1; i <= numMercadorias; i++) {
//         faturamentoMensal += precos[i] * quantidadesVendidas[i];
//     }
//     printf("O faturamento mensal do armazém é: %.2lf\n", faturamentoMensal);
//     return 0;
// }
